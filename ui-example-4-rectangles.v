...
// In this version, since the context only exists within the scope of the frame function, 
// the `free()` method detaches the context and synchronizes the threads so that 
// the output is usable during the next frame call.
